...
LATITUDE = '44.467035'
LONGITUDE = '26.106539'
CITY_RADIUS = 10  # in kilometers, approximating Bucharest's spread
...
def create_map(cloud_coverage):
    ...
    folium.Circle(
        ...
        radius=CITY_RADIUS * 1000,  # multiplied by 1000 to convert km to meters
        popup=f"Cloud Coverage: {cloud_coverage}%",
        color='blue',
        fill=True,
        fill_color='blue',
        fill_opacity=cloud_coverage/100  # opacity corresponds to cloud percentage
    ).add_to(m)
...
open_map_btn = tk.Button(app, text="Open Map", command=display_map, font=("Arial", 12))
